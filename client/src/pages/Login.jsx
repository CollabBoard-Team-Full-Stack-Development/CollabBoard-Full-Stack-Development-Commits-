...
export const Login = () => {
  ...
  const [email, setEmail] = useState('manager@collabboard.com');
  ...
  return (
    <div className="min-h-screen w-full bg-[#090B13] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
          ...
          <div className="flex items-center justify-between text-xs pt-1">
            <label className="flex items-center gap-2 cursor-pointer text-text-secondary hover:text-text-primary">
              <input
                ...
                className="rounded bg-card border-border text-purple focus:ring-purple/40 cursor-pointer"
              />
            ...
            <button
              ...
              className="text-purple hover:text-purple-hover font-medium transition-colors cursor-pointer"
            >
              Forgot Password?
            </button>
          </div>

          {/* Main Native Submit Button */}
          <button
            type="submit"
            disabled={loading}
        ...
        {/* Quick Role-testing helper bar */}
        <div className="mt-5 p-3 bg-background/50 border border-border/60 rounded-xl text-[11px] text-text-secondary text-center space-y-1.5">
          <p className="font-semibold text-text-primary">Quick Role Select for Testing:</p>
          <div className="flex justify-center gap-2">
            <button
              type="button"
              onClick={() => { setEmail('manager@collabboard.com'); setPassword('password123'); }}
              className="px-2.5 py-1 bg-purple/20 hover:bg-purple/30 text-purple rounded-md transition-colors cursor-pointer font-medium"
            >
              Set as Admin (PM)
            </button>
            <button
              type="button"
              onClick={() => { setEmail('employee@collabboard.com'); setPassword('password123'); }}
              className="px-2.5 py-1 bg-cardHover hover:bg-border text-text-secondary rounded-md transition-colors cursor-pointer font-medium"
            >
              Set as Employee
            </button>
          </div>
